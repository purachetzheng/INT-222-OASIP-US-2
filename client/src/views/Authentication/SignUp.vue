...
<template>
    <AuthPageTemplate>
        ...
        <template #img>
            <img src="../../assets/images/illustrations/Curious-bro.svg" alt="" />
        </template>
        <RoleSelectField />
        <app-vee-input name="name" type="name" placeholder="Name" label="Name" :max="100" required counter />
        <app-vee-input name="email" type="email" placeholder="Email" label="Email" :max="100" required counter />
        <app-vee-input
            name="password"
            type="password"
        ...
        <div class="text-center mt-4">
            <div class="text-sm font-medium">
                ...
                <router-link :to="{ name: 'SignIn' }" class="text-indigo-500 underline"> Sign In </router-link>
            </div>
        </div>
    </AuthPageTemplate>
</template>
